...
const Dashboard = () => {
  ...
  const [bgImage, setBgImage] = useState("https://source.unsplash.com/1600x900/?luxury-cars");
  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h1 style={{ fontSize: "48px", fontWeight: "bold", marginBottom: "30px", animation: "fadeIn 1.5s ease-in-out" }}>
          Welcome!
        </h1>
        {isLoggedIn && (
